...
<v-card>
    <v-layout>
        ...
        <v-list density="compact" nav>
            <v-list-item prepend-icon="mdi-newspaper" title="Posts" value="posts" @click="$router.push({path: '/posts'})"></v-list-item>
            <v-list-item prepend-icon="mdi-rake" title="Crawlers" value="crawlers" @click="$router.push({path: '/crawlers'})"></v-list-item>
        </v-list>
        </v-navigation-drawer>
